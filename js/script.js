...
const products = [
    ...
    { number: 62, name: "Bandeja Manzana Verde.", category: "FRUTAS" },
    { number: 63, name: "Bandeja Manzana Mixta.", category: "FRUTAS" },
    { number: 64, name: "Uva Roja.", category: "FRUTAS" },
    { number: 65, name: "Uva Verde.", category: "FRUTAS" },
    { number: 66, name: "Uva Chilena.", category: "FRUTAS" },
    { number: 67, name: "Uva Isabella.", category: "FRUTAS" },
    { number: 68, name: "Ciruela Chilena.", category: "FRUTAS" },
    { number: 69, name: "Kiwi.", category: "FRUTAS" },
    { number: 70, name: "Pera Chilena.", category: "FRUTAS" },
    { number: 71, name: "Durazno Chileno.", category: "FRUTAS" },
    { number: 72, name: "Cereza.", category: "FRUTAS" }, 
    { number: 73, name: "Pitaya.", category: "FRUTAS" },
    { number: 74, name: "Borojo.", category: "FRUTAS" },
    { number: 75, name: "Higo.", category: "FRUTAS" },
    { number: 76, name: "Tomate Árbol Común.", category: "FRUTAS" },
    { number: 77, name: "Curuba.", category: "FRUTAS" },
    { number: 78, name: "Mango Azúcar.", category: "FRUTAS" },
    { number: 79, name: "Mango Común.", category: "FRUTAS" },
    { number: 80, name: "Mango Yolima.", category: "FRUTAS" },
    { number: 81, name: "Feijão.", category: "FRUTAS" },
    { number: 82, name: "Ciruela Nacional.", category: "FRUTAS" },
    { number: 83, name: "Carambolo.", category: "FRUTAS" },
    { number: 84, name: "Tomate Pollo.", category: "FRUTAS" },
